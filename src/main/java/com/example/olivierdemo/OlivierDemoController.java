...
public class OlivierDemoController {
	...
	public ModelAndView viewparcellecadastrale(@PathVariable("id") int id) {
		...
		//return new ModelAndView("parcellecadastraleview", "parcellecadastrale", parcellecadastrale);
	}
		...
		try {
			...
			// INTEGRATION PARCELLE CADASTRALE
						...
						while (iterator6.hasNext()) {
							...
							Forest forest = OlivierDemoProxy.forestview(Integer.parseInt(formatter3.formatCellValue(currentRow1.getCell(0))));							

							//Parcelle forestiere
							DataFormatter formatter1 = new DataFormatter();							
							ParcelleForestiere parcelleforestieres1 = OlivierDemoProxy.parcelleforestiereview(Integer.parseInt(formatter1.formatCellValue(currentRow1.getCell(2))));	

							// Parcelle cadastrale
							DataFormatter formatter2 = new DataFormatter();							
							ParcelleCadastrale parcellecadastrales1 = OlivierDemoProxy.parcellecadastraleview(Integer.parseInt(formatter1.formatCellValue(currentRow1.getCell(1))));

							// STATION FORESTIERE
							DataFormatter formatter8 = new DataFormatter();
							StationForestiere stationforestieres1 = OlivierDemoProxy.stationforestiereview(Integer.parseInt(formatter8.formatCellValue(currentRow1.getCell(8))));
							...
							for (Iterator<ParcelleCadastrale> it = parcelleforestieres1.getParcellecadastrales()
									.iterator(); it.hasNext();) {
							...
							ParcelleCadastrale parcellecadastrales2 = OlivierDemoProxy.parcellecadastraleview(Integer.parseInt(formatter1.formatCellValue(currentRow1.getCell(1))));
